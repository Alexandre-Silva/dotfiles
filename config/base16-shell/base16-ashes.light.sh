...
color_foreground="56/5E/65" # Base 02
color_background="F3/F4/F5" # Base 07
color_cursor="56/5E/65" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 565E65 # forground
  printf $printf_template_custom Ph F3F4F5 # background
  printf $printf_template_custom Pi 565E65 # bold color
  printf $printf_template_custom Pj C7CCD1 # selection color
  printf $printf_template_custom Pk 565E65 # selected text color
  printf $printf_template_custom Pl 565E65 # cursor
  printf $printf_template_custom Pm F3F4F5 # cursor text
else
