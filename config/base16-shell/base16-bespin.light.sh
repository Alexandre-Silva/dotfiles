...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 5e5d5c # forground
  printf $printf_template_custom Ph baae9e # background
  printf $printf_template_custom Pi 5e5d5c # bold color
  printf $printf_template_custom Pj 8a8986 # selection color
  printf $printf_template_custom Pk 5e5d5c # selected text color
  printf $printf_template_custom Pl 5e5d5c # cursor
  printf $printf_template_custom Pm baae9e # cursor text
else
