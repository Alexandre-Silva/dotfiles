...
color_foreground="00/55/00" # Base 02
color_background="00/ff/00" # Base 07
color_cursor="00/55/00" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 005500 # forground
  printf $printf_template_custom Ph 00ff00 # background
  printf $printf_template_custom Pi 005500 # bold color
  printf $printf_template_custom Pj 00bb00 # selection color
  printf $printf_template_custom Pk 005500 # selected text color
  printf $printf_template_custom Pl 005500 # cursor
  printf $printf_template_custom Pm 00ff00 # cursor text
else
