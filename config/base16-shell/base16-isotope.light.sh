#!/bin/sh
# Base16 Isotope - Shell color setup script
# Jan T. Sott
...
color_foreground="60/60/60" # Base 02
color_background="ff/ff/ff" # Base 07
color_cursor="60/60/60" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 606060 # forground
  printf $printf_template_custom Ph ffffff # background
  printf $printf_template_custom Pi 606060 # bold color
  printf $printf_template_custom Pj d0d0d0 # selection color
  printf $printf_template_custom Pk 606060 # selected text color
  printf $printf_template_custom Pl 606060 # cursor
