...
color_foreground="7F/8C/8D" # Base 02
color_background="EC/F0/F1" # Base 07
color_cursor="7F/8C/8D" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 7F8C8D # forground
  printf $printf_template_custom Ph ECF0F1 # background
  printf $printf_template_custom Pi 7F8C8D # bold color
  printf $printf_template_custom Pj e0e0e0 # selection color
  printf $printf_template_custom Pk 7F8C8D # selected text color
  printf $printf_template_custom Pl 7F8C8D # cursor
  printf $printf_template_custom Pm ECF0F1 # cursor text
else
