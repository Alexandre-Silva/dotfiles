...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg bbbbbb # forground
  printf $printf_template_custom Ph 111111 # background
  printf $printf_template_custom Pi bbbbbb # bold color
  printf $printf_template_custom Pj 555555 # selection color
  printf $printf_template_custom Pk bbbbbb # selected text color
  printf $printf_template_custom Pl bbbbbb # cursor
