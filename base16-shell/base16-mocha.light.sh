...
color_foreground="64/52/40" # Base 02
color_background="f5/ee/eb" # Base 07
color_cursor="64/52/40" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 645240 # forground
  printf $printf_template_custom Ph f5eeeb # background
  printf $printf_template_custom Pi 645240 # bold color
  printf $printf_template_custom Pj d0c8c6 # selection color
  printf $printf_template_custom Pk 645240 # selected text color
  printf $printf_template_custom Pl 645240 # cursor
  printf $printf_template_custom Pm f5eeeb # cursor text
else
