...
color_foreground="50/50/50" # Base 02
color_background="ff/ff/ff" # Base 07
color_cursor="50/50/50" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 505050 # forground
  printf $printf_template_custom Ph ffffff # background
  printf $printf_template_custom Pi 505050 # bold color
  printf $printf_template_custom Pj e0e0e0 # selection color
  printf $printf_template_custom Pk 505050 # selected text color
  printf $printf_template_custom Pl 505050 # cursor
