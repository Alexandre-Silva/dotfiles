...
color_foreground="46/4b/50" # Base 02
color_background="ff/ff/ff" # Base 07
color_cursor="46/4b/50" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 464b50 # forground
  printf $printf_template_custom Ph ffffff # background
  printf $printf_template_custom Pi 464b50 # bold color
  printf $printf_template_custom Pj a7a7a7 # selection color
  printf $printf_template_custom Pk 464b50 # selected text color
  printf $printf_template_custom Pl 464b50 # cursor
