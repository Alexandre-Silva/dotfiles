...
color_foreground="4a/45/43" # Base 02
color_background="f7/f7/f7" # Base 07
color_cursor="4a/45/43" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 4a4543 # forground
  printf $printf_template_custom Ph f7f7f7 # background
  printf $printf_template_custom Pi 4a4543 # bold color
  printf $printf_template_custom Pj a5a2a2 # selection color
  printf $printf_template_custom Pk 4a4543 # selected text color
  printf $printf_template_custom Pl 4a4543 # cursor
