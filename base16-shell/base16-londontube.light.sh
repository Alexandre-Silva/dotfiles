#!/bin/sh
# Base16 London Tube - Shell color setup script
# Jan T. Sott
...
color_foreground="5a/57/58" # Base 02
color_background="ff/ff/ff" # Base 07
color_cursor="5a/57/58" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 5a5758 # forground
  printf $printf_template_custom Ph ffffff # background
  printf $printf_template_custom Pi 5a5758 # bold color
  printf $printf_template_custom Pj d9d8d8 # selection color
  printf $printf_template_custom Pk 5a5758 # selected text color
  printf $printf_template_custom Pl 5a5758 # cursor
