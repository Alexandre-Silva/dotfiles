...
color_foreground="18/4E/45" # Base 02
color_background="D2/E7/E4" # Base 07
color_cursor="18/4E/45" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 184E45 # forground
  printf $printf_template_custom Ph D2E7E4 # background
  printf $printf_template_custom Pi 184E45 # bold color
  printf $printf_template_custom Pj 81B5AC # selection color
  printf $printf_template_custom Pk 184E45 # selected text color
  printf $printf_template_custom Pl 184E45 # cursor
  printf $printf_template_custom Pm D2E7E4 # cursor text
else
