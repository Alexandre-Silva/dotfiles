...
color_foreground="55/55/55" # Base 02
color_background="ff/ff/ff" # Base 07
color_cursor="55/55/55" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 555555 # forground
  printf $printf_template_custom Ph ffffff # background
  printf $printf_template_custom Pi 555555 # bold color
  printf $printf_template_custom Pj bbbbbb # selection color
  printf $printf_template_custom Pk 555555 # selected text color
  printf $printf_template_custom Pl 555555 # cursor
